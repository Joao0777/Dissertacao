...
if __name__ == "__main__":
    diretorio_base = "C:/Users/Portilho/Desktop/Resultados/Result_metabo/5EBK/FAD/1b_G1"
    arquivo_saida = os.path.join(diretorio_base, "Hbond_NOS_norma_compara_Tripanotiona.txt")
