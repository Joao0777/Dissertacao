...
def replace_mol2_content(mol2_path, coordinates, charges):
    ...
    for i, line in enumerate(mol2_lines[start_line:start_line + len(coordinates)]):
        ...
        mol2_lines[start_line + i] = f"{line.split()[0]:>4}  {atom_info[0]:<3} {coordinates[i][0]:>10} {coordinates[i][1]:>10} {coordinates[i][2]:>10}  {atom_infor[0]:<5}     1   UNK0   {charges[i]:>10}\n"
...
def main():
    ...
    folder2 = Path('C:/Users/Portilho/Desktop/Docking_certo/Metabolitos/Metabo_Arq_Prep/1a_G1/MOPAC_3output')
    folder3 = Path('C:/Users/Portilho/Desktop/Docking_certo/Metabolitos/Metabo_Arq_Prep/1a_G1/MOPAC_2cargas')
